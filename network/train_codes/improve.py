'''
improve the the basic BSD-Resnet18 network
imporve the overfitting problem
...
writer = SummaryWriter('runs/resnet18_improved/bd')
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        writer.add_scalar('training loss', losses.avg, t_step)
        writer.add_scalar('training accuracy', top1.avg, t_step)
        # random mini-batch
        ...
        if t_step % args.check_interval == 0:
            save_checkpoint({
                ...
                'best_F1': best_F1,
                'best_loss': best_loss
            }, False, False, False, False, False,'checkpoint')
